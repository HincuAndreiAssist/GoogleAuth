using GoogleAuth.Auth.Validators;
...
namespace GoogleAuth
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                googleOptions.ClientId = "762959993672-26ruoc45s4i20p5q9cup85ljjphbbno2.apps.googleusercontent.com";
                googleOptions.ClientSecret = "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";
            })
            .AddJwtBearer(o =>
            {
